...
import { ADD_HASTAG_FORMAT_MODAL, EDIT_HASTAG_FORMAT_MODAL, HASHTAG_FORMAT_TABLE } from "../../../libs/constants/formats/TagFormat";
              ...
              >
                {DataTable.tags.map((item, index) => (
                  <tr
                    ...
                    key={item.id}
                  >
                    <TableFeature attribute={HASHTAG_FORMAT_TABLE.attribute} index={index}/>
