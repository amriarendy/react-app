        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <button
                type="button"
                className="flex items-center w-full p-2 text-base text-gray-900 transation duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
              ...
              >
                ...
                <span
                  className="flex-1 ml-3 text-left whitespace-nowarp"
                  sidebar-toggle-item
                >
                  Dropdown
                </span>
