...
import AboutBacgkround from "../../../elements/background/AboutBackground";
          ...
          <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600 dark:text-white">
            <div className="flex gap-x-4">
              <dt className="flex-none">
                ...
                <FaGithub className="h-7 w-10 text-gray-400" />
              </dt>
              <dd>
            ...
            <div className="flex gap-x-4">
              <dt className="flex-none">
                ...
                <FaLinkedin className="h-7 w-10 text-gray-400" />
              </dt>
              <dd>
            ...
            <div className="flex gap-x-4">
              <dt className="flex-none">
                ...
                <FaInstagram className="h-7 w-10 text-gray-400" />
              </dt>
              <dd>
